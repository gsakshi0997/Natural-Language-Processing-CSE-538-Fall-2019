...
class ProbingClassifier(models.Model):
    def __init__(self,
        ...
        # TODO(students): start
        self._layers_prob=tf.keras.layers.Dense(classes_num, activation='softmax')
        # TODO(students): end
    ...
    def call(self, inputs: tf.Tensor, training: bool =False) -> tf.Tensor:
        ...
        """
        # TODO(students): start
        comb_vector = self._pretrained_model(inputs)
        #print (comb_vector)
        #pdb.set_trace()
        l=self._layer_num-1
        logits = self._layers_prob(comb_vector['layer_representations'][:, l, :])
        # TODO(students): end
